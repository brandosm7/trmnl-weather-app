...
LATITUDE = float(os.environ.get("LATITUDE", "") or "42.77275")
LONGITUDE = float(os.environ.get("LONGITUDE", "") or "-86.211787")

# TRMNL Private Plugin UUID (from your TRMNL account)
TRMNL_PLUGIN_UUID = os.environ.get("TRMNL_PLUGIN_UUID", "") or "c0d6d16f-2184-4cb1-b66b-c5fcb56783de"
